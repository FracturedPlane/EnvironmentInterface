...
public interface EnvironmentInterfaceStandard 
{
	 ...
	 */
	void attachAgentListener(Agent agent, AgentConnectionHandler listener);
	 ...
	 * @param listener is the listener of the agent
	 */
	void detachAgentListener(Agent agent, AgentConnectionHandler listener);
	 ...
	 */
	void registerAgent(Agent agent) throws AgentException;
	 ...
	 */
	void unregisterAgent(Agent agent) throws AgentException;
	 ...
	 */
	void associateEntity(Agent agent, Entity entity) throws RelationException;
	 ...
	 */
	void freeEntity(Entity entity) throws RelationException;
	 ...
	 */
	void freeAgent(Agent agent) throws RelationException;
	 ...
	 */
	void freePair(Agent agent, Entity entity) throws RelationException;
	 ...
	 * @return a list of entity-ids.
	 */
	LinkedList<Entity> getFreeEntities();
	 ...
	 */
	LinkedList<Percept> performAction(Agent agent, Action action,
	 ...
	 */
	LinkedList<Percept> getAllPercepts(Agent agent, Entity... entities)
	 ...
	 */
	String getType(Entity entity) throws EntityException;
